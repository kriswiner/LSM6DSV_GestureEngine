...
void LSM6DSV::ActivityDetect(uint8_t inactiveTime, uint8_t sleepMode)
{
  ...
  _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_INACTIVITY_DUR, 0x38);              // set LSB to 62.5 mg, accel ODR to 30 Hz
...
void LSM6DSV::singleTapDetect()
{
  ...
  temp = _i2c_bus->readByte(LSM6DSV_ADDRESS, LSM6DSV_MD2_CFG);             // preserve interrupt existing routing
  _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_MD2_CFG, temp | 0x40);      // add single tap routing to INT2
}
...
void LSM6DSV::D6DOrientationDetect()
{
 ...
 _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_TAP_THS_6D, temp | 0x40);    // set 6D threshold to 60 degrees
  temp = _i2c_bus->readByte(LSM6DSV_ADDRESS, LSM6DSV_MD2_CFG);             // preserve interrupt existing routing
  _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_MD2_CFG, temp | 0x04);      // add 6D rotation detect routing to INT2
}
...
void LSM6DSV::FSMprograms() {
    ...
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x00);                             // write to FSM_START_ADDRESS_L
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x04);                             // write to FSM_START_ADDRESS_H
...
// wrist tilt program 1
    ...
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x10);                             // write to TIMER3
...
// motion detect program 3
    ...
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x00);                             // write to TMASKA
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x00);                             // write to TC
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x7D);                             // write to TIMER3 (125 samples at 26 Hz = 4.8 seconds)
...
// glance detection program 4
    ...
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x00);                             // write to TC
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x00);                             // write to TC
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x02);                             // write to TIMER1 ( 2 samples at 26 Hz = 0.0772 seconds) LSB
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x00);                             //  MSB
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x20);                             // write to TIMER2 (32 samples at 26 Hz = 1.23 seconds) LSB
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x00);                             //  MSB
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x0A);                             // write to TIMER3 (16 samples at 26 Hz = 0.39 seconds)
    _i2c_bus->writeByte(LSM6DSV_ADDRESS, LSM6DSV_PAGE_VALUE, 0x03);                             // write to TIMER4 ( 3 samples at 26 Hz = 0.10 seconds)
