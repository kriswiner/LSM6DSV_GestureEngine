...
#define inactAODR_1_875Hz 0x00   
#define inactAODR_15Hz    0x01 // default
#define inactAODR_30Hz    0x03
#define inactAODR_60Hz    0x03
...
class LSM6DSV
{
  ...
  uint8_t EMBstatus();
  uint8_t FSMstatus();
  void ActivityDetect(uint8_t inactiveTime, uint8_t inactODR, uint8_t sleepMode);
  ...
  void idleLPS22DF( );
  void resumeLPS22DF(uint8_t PODR, uint8_t AVG);
